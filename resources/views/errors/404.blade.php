...
<head>
    <!-- Title -->
    <title>Erreur 404 - Portfolio d'Alexis Faizeau</title>
...
<main class="g-min-height-100vh g-flex-centered g-pa-15">
    <div class="text-center g-flex-centered-item g-position-rel g-pb-15">
        ...
        <div class="g-absolute-centered">
            ...
            <p class="g-font-size-18 mb-0"><a href="{{ route('home') }}" class="g-color-black g-color-primary--hover g-text-no-underline--hover">← Page d'Acceuil</a></p>
        </div>
    </div>
</main>
